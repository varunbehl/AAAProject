...
ON (ARCH_CALL.SC_CALL_MBR_ID=MEMBERX.MBR_ID and ARCH_CALL.SC_CALL_ASC_ID=MEMBERX.ASSOC_MBR_ID) where SC_DT > '01-JAN-17' and CHG_ENTITLEMENT = 'Y' and MEMBERSHIPX.MBRS_STS_CD = 'A' and PLUS_IND = 'B' AND rownum < 100
