...
public class CRTowDestinationPage {
	...
	static {
		...
		lblLatLog=By.className("repair-shop-lat-lon");
		...
		iconTRC=By.className("shop-icon d3ui-icon d3ui-icon-trc");
		chkBoxOpenOn=By.id("td-repair-shop-search-datetime-cbx");
		chkBoxAAR=By.className("shop-icon d3ui-icon d3ui-icon-aar");
