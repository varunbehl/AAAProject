...
public class CR_DI_ITU_WebModified extends LoginLib
{
    	...
    	try
    	{
    		...
    		for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
    		{
    			try {
		                ...
		                dimcdLib.lblCallDispatchedStatus(data.get("statusupdatediitu"));
		                //verify enroute status
		                dimcdLib.lblCallENRouteStatus(data.get("statusupdateeritu"));
		                //verify onlocation
		                dimcdLib.lblCallOnLocationStatus(data.get("statusupdateolitu"));
		                //verify towstatus
		                dimcdLib.lblCallTowStatus(data.get("statusupdatetwitu"));
		                //verify clearcall
		                dimcdLib.labelCallCleared(data.get("statusupdateclitu"));
		                //logout
		                diHomeLib.logOut();
