...
public class TC_RSOWLaunchViaPartnerRedirect extends ActionEngine{
    ...
    public void launchViaPartnerRedirect(int StartRow,String EndRow,boolean nextTestJoin) throws Throwable {
		try
    	{
    		...
    		int intEndRow=ReportControl.fnGetEndRowCunt(EndRow, "launchViaPartnerRedirect", TestData, "RSOWeb_Login");
    		for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
    		{
    			try {
    					ReportStatus.fnDefaultReportStatus();
    					ReportControl.intRowCount=intCounter;
    					Hashtable<String, String> data=TestUtil.getDataByRowNo("launchViaPartnerRedirect", TestData, "RSOWeb_Login",intCounter);
    			...
    			ReportStatus.fnUpdateResultStatus("RSO","7777",ReportStatus.strMethodName,intCounter,browser);
    		}
    	}
    	catch (Exception e) 
    	{
