		...
		try {
			...
			for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
			{
				try {
						...
						this.reporter.initTestCaseDescription("1707:TC-ValidatekillProcessForCalls == " + "from " + intStartRow + " to " + intEndRow);
				 ...
				 //ReportStatus.fnUpdateResultStatus("CR","34675",ReportStatus.strMethodName,intCounter,browser);
				 ReportStatus.fnUpdateResultStatusEE("CR","34675","EE_Login_Verification","Web",ReportStatus.strMethodName,intCounter,browser);
				}
		} catch (Exception e) {
			e.printStackTrace();
		...
		try {
			...
			for(int intCounter=intStartRow;intCounter<=intEndRow;intCounter++)
			{
				try {
				 ...
				 ReportStatus.fnUpdateResultStatus("CR","34676",ReportStatus.strMethodName,intCounter,browser);
				}
		} catch (Exception e) {
			e.printStackTrace();
			throw new RuntimeException(e);
