...
public class TestEngineMobile {
	public Logger LOG = Logger.getLogger(TestEngineMobile.class);
	protected static AppiumDriver appiumDriver = null;
	protected WebDriver WebDriver = null;
	public EventFiringWebDriver driver = null;
    protected static CReporterWeb reporter = null; //Pankaj Changes
	...
	public void beforeSuite(ITestContext ctx, String type, String suite)
		...
		else if(ReportControl.blnJoin==true)
		{
			startTime=TestEngineWeb.startTime;
			LOG=TestEngineWeb.LOG;
			PropertyConfigurator.configure(System.getProperty("user.dir")
					+ "/Log.properties");
		}
	}
	...
	public void beforeTest(String automationName, String browserName,
		...
		if (environment.equalsIgnoreCase("local")) {
			...
			if (platformName.equalsIgnoreCase("android") && !app.equalsIgnoreCase("NA")) {
				...
				reporter = CReporterWeb.getCReporter(deviceName, platformName,platformVersion, false);
	...
	public void beforeMethod(Method method) {
		...
		{
			reporter=TestEngineWeb.reporter;
		}
	...
	public void afterMethod() throws Throwable {
		...
		{
			TestEngineWeb.LOG=LOG;
			TestEngineWeb.reporter=reporter;
		}
