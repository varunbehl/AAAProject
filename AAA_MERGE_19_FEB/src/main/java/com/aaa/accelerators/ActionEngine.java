...
public class ActionEngine extends TestEngineWeb {
	//declarations
	public final Logger LOG = Logger.getLogger(ActionEngine.class);
	...
	public boolean isElementPresent(By by, String locatorName, boolean expected) throws Throwable {
		...
		try {
			...
			if (!status) {
				...
				LOG.info("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
				TestEngineWeb.reporter.SuccessReport("isElementPresent : " + locatorName, this.msgIsElementFoundSuccess + locatorName);
			}
			reportIndicator = true;
		}
		return status;
...
*/
	...
	protected void sendKeys(String combineKeys,String combineKeysName) throws Throwable {
		...
		TestEngineWeb.reporter.SuccessReport("Sending Keys :: " + combineKeysName, "Successfully send keys :: " +combineKeysName);
	}
